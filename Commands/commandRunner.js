function commandRunnerFunction() {
  ...
  for (var i=0; i<varList.length; i++) {
    if ((currentCommand[lineNumber].indexOf(varList[i]) !== -1 || currentCommand[lineNumber].indexOf("++") !== -1) && currentCommand[lineNumber].indexOf("var") == -1 && currentCommand[lineNumber].indexOf("=") !== -1  && currentCommand[lineNumber].indexOf("if") == -1) {
      containsVar = true
    }
  }
